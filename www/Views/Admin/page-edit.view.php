...
<header id="header">
  ...
  <form id="pageForm" action="/admin/pages/add-page" method="post">
    ...
    <input type="text" name="title_page" id="title-input"
      value="<?php echo htmlspecialchars($page->getTitle_page()); ?>" placeholder="Titre de la page"
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    const editor = grapesjs.init({
      ...
      storageManager: {
        autoload: false, // Empêche le chargement automatique
        type: 'none' // Désactive le stockage local
      },
      assetManager: {
        embedAsBase64: true
      },
...
`,
    ...
    // Préparez les données à sauvegarder lors de la soumission du formulaire
