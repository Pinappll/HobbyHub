...
{
    // Est-ce qu'on a le bon nombre d'inputs ?
    foreach ($config["inputs"] as $name => $input) {
        // Si l'input est une checkbox et qu'elle n'est pas présente dans $data, elle est décochée
        if ($input["type"] === "checkbox" && !isset($data[$name])) {
        ...
        // Effectuer les validations spécifiques pour certains champs
